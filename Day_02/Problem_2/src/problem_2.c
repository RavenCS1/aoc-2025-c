...
void number_split_without_middle(needed_type number, needed_type first_half[const static 1], needed_type second_half[const static 1]) {
    register int n = count_digits(number);
    register int half_len = n / 2;
...
bool split_6_for_2_digit_number(needed_type number) {
    register const int division_1 = (int) (pow(10, 4)); 
    register const int division_2 = (int) (pow(10, 2));
...
bool split_9_for_3_digit_number(needed_type num) {
    register const int division_1 = (int) (pow(10, 6));
    register const int division_2 = (int) (pow(10, 3));
